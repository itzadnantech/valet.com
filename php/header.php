            ...
            <div class="header navbar">
                <div class="header-container">
                    ...
                    <ul class="nav-right">
                        <li class="notifications dropdown"><span class="counter count bgc-red">0</span>
                            <a href="#" class="dropdown-toggle no-after" data-toggle="dropdown"><i class="ti-bell"></i></a>
                            <ul class="dropdown-menu">
                                    <span class="fsz-sm fw-600 c-grey-900">Notifications</span>
                                <li role="separator" class="divider"></li>
                                <li>
                                    <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm drop-menu">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                                ...
                                <div class="peer"><span class="fsz-sm c-grey-900"><?php echo $_SESSION["name"]."'s account" ?></span></div>
                            </a>
                            <ul class="dropdown-menu fsz-sm">
                               <!-- <li><a href="#" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-settings mR-10"></i> <span>Setting</span></a></li>
                                <li><a href="#" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"><i class="ti-user mR-10"></i> <span>Settings</span></a></li>-->
                                <li><a href="changepassword.php" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700"> <span>Change password</span></a></li>
                                <li role="separator" class="divider"></li>
